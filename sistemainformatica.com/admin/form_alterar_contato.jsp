                ...
                <section id="sectionAdministrativo" class="section col-xs-12">
                    <center>
                        <form action="../gerente_contato.do" method="POST" name="form_inserirContato" class="form">
                            ...
                            <input type="text" name="telefone_contato" id="telefoneCelular" size="60" placeholder="Insira se for 'Telefone'"  required value="<%=contato.getConteudo()%>"><br/>

                            <label style="display: none">Endereço: </label><br/>
                            <input style="display: none" type="text" name="endereco_contato"  size="60" placeholder="Insira se for 'Endereco'" maxlength="100"><br/>

                            <label style="display: none">Rede Social: <span>Sem "http://"</span></label><br/>
                            <input style="display: none" type="text" name="redeSocial_contato" size="60" placeholder="Insira se for 'Rede Social'" maxlength="100"><br/><br/>

                            <label style="display: none">Outro:</label><br/>
                            <input style="display: none" type="text" name="outro_contato" size="60" placeholder="Insira se for 'Outro'" maxlength="100"><br/><br/>


                            <%} else if (contato.getTipo().equals("Endereco")) {%>
                            <label style="display: none">Telefone: </label><br/>
                            <input style="display: none" type="text" name="telefone_contato" id="telefone" size="60" placeholder="Insira se for 'Telefone'" maxlength="11"><br/>

                            <label>Endereço: </label><br/>
                            <input type="text" name="endereco_contato"  size="60" placeholder="Insira se for 'Endereco'" maxlength="100" value="<%=contato.getConteudo()%>"><br/>
                            ...
                            <input type="text" name="redeSocial_contato" size="60" placeholder="Link se 'Rede Social'" maxlength="100" value="<%=contato.getConteudo()%>"><br/><br/>
                            ...
                            <input type="text" name="outro_contato" size="60" placeholder="Insira se for 'Outro'" maxlength="100" value="<%=contato.getConteudo()%>"><br/><br/>
                            <%}%>
