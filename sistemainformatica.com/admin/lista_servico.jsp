...
<meta name="viewport" content="width=device-width, inicial-scale=1">
        ...
        <script type="text/javascript">
            function excluir(id) {
                var url = "../gerente_servico.do?opExcluir=excluir&idExcluir=" + id;
                    ...
                    <div class="row">
                        <ul id=ulSmall type="none" class="ulMenu col-xs-12">
                            ...
                            <li id="liMenuSmall_empresa" class="liMenu liMenuSmall">
                                ...
                                <a href="form_inserirServico.jsp" class="link">Inserir Serviço</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <nav class="nav">
                            <ul type="none" class="ulMenu">
                                ...
                                <li id="list_liMenu_inserirServico" class="liMenu">
                                    <i class="fa fa-plus"></i>
                                    <button class="button btnMenu" onclick="location = 'form_inserir_servico.jsp'">Inserir Serviço
                                    </button>
                                </li>
                            </ul>
                        </nav>
                ...
                <section id="sectionAdministrativo" class="section col-xs-12">
                    <center>
                        <h5 id="msg_servico" style="display: none;">Não há dados</h5>
                        <table id="table_servico" id="table" class="tableSmall" style="visibility: hidden;">
                            <tr>
                            ...
                            <script>
                                $(document).ready(function () {
                                    $("#msg_servico").css('display', 'block');
                                });
                            </script> 
                            <button class="button btnAdmin" onclick="location='form_inserir_servico.jsp'">
                                <i class="fa fa-plus"></i>&nbsp;Inserir
                            </button>
                            <%}else {%>
                            <script>
                                $(document).ready(function () {
                                    $("#msg_servico").css('display', 'none');
                                    $("#table_servico").css('visibility', 'visible');
                                });
                            </script> 
                            <%
                            ...
                            <tr>
                                ...
                                <td class="table_border table_padding">
                                    ...
                                    <br/>
                                    <button class="button btnOpcao" onclick="if(confirm('Deseja realmente excluir o serviço?')){location='../gerente_servico.do?opExcluir=excluir&imagemExcluir=<%=servico.getImagem()%>&idExcluir=<%=servico.getId()%>&diretorio=<%=servico.getDiretorio()%>&servico=<%=servico.getDiretorio()%>';}">
