...
<%    Empresa empresa = new Empresa();
    ...
    try {
        empresa = empresaDAO.listaValores(empresa);
    } catch (Exception e) {
                ...
                <section id="sectionAdministrativo" class="section col-xs-12">
                    <center>
                        <form action="../gerente_empresa.do" method="POST" name="form_alterar_infoEmpresa" id="form_inserirServico" class="form">
                            <input type="hidden" name="tema" value="valores">
                            <label>Título: <span>Max: 50 caracteres</span> </label><br/> <input type="text" name="titulo" placeholder="Insira o título da descricao" size="50" maxlength="50" value="Valores" readonly><br/><br/>
                            <label>Descricao:</label><br/> 
                            <textarea id="textarea" name="descricao"><%=empresa.getValores()%></textarea><br/><br/>
