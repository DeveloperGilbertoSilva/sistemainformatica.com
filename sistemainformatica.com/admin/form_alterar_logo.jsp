            ...
            <div class="row">
                ...
                <header id="headerAdministrativo" class="header col-xs-12">
                    <h1 class="title">
                        ...
                        Alteração de contato - Página Inicial
                    </h1>
                ...
                <section id="sectionAdministrativo" class="section col-xs-12">
                    <center>
                        ...
                        <form action="../gerente_index.do" method="POST" name="form_inserirContato" class="form" enctype="multipart/form-data">
                            ...
                            <br/>
                            <input type="file" name="logomarca" id="logo" accept=".png" required>
                            <%} else {%>
            ...
            function filePreview(input){
                if(input.files && input.files[0]){
                    ...
                    reader.onload = function(e){
                        $("#logo + img").remove();
                        $("#logo").after('<img src="'+e.target.result+'"width="80" height="80" style="position: relative; top: 10px; border-radius: 20px;">');
                    };
