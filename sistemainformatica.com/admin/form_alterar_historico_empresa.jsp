...
<%
    ...
    try {
        empresa = empresaDAO.listaHistorico(empresa);
    } catch (Exception e) {
                        ...
                        <nav class="nav">
                            <ul type="none" class="ulMenu">
                                ...
                                <li id="form_liMenu_pagInicial" class="liMenu">
                                    ...
                                    <button class="button btnMenu" onclick="location = 'lista_tema_empresa.jsp'">Lista desrição
                                    </button>
                                </li>
                            </ul>
                        </nav>
                ...
                <section id="sectionAdministrativo" class="section col-xs-12">
                    <center>
                        <form action="../gerente_empresa.do" method="POST" name="form_alterar_infoEmpresa" id="form_inserirServico" class="form">
                            <input type="hidden" name="tema" value="historico">
                            <label>Título: <span>Max: 50 caracteres</span> </label><br/> <input type="text" name="titulo" placeholder="Insira o título da descricao" size="50" maxlength="50" value="Histórico" readonly><br/><br/>
                            <label>Descricao:</label><br/> 
                            <textarea id="textarea" name="descricao"><%=empresa.getHistorico()%></textarea><br/><br/>
