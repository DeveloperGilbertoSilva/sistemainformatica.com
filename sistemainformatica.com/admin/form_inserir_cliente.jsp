        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <section id="sectionAdministrativo" class="section col-xs-12">
                    <center>
                        <form action="../gerente_cliente.do" method="POST" name="form_inserirCliente" class="form" id="form_cliente" enctype="multipart/form-data">
                            <input type="hidden" name="op" value="inserir">
                            <label>Nome: <span>Max: 50 caracteres</span> </label><br/> <input type="text" name="nome" placeholder="Insira o nome do cliente" size="50" maxlength="50"><br/><br/>
                            <label>Site:</label><br/> <input type="text" name="site" placeholder="Insira a URL (sem http://)" size="50" maxlength="80"><br/><br/>
                            <label>Descrição:</label><br/>
                            <textarea name="descricao" maxlength="600" cols="30" rows="10"></textarea><br/><br/>
                            <label>Logo:</label>
                            <h5 style="color: red;">Tamanho recomendado: 80x80</h5>
                            <br/>
                            <input type="file" name="logo" id="logo_cliente" accept=".jpg" required>
                            <br/><br/>
                            <input type="submit" name="btnEnviar" class="button btnAdmin" value="Inserir Cliente">
                        </form>
                    </center>
                </section>
            ...
            function filePreview(input){
                if(input.files && input.files[0]){
                    ...
                    reader.onload = function(e){
                        $("#logo_cliente + img").remove();
                        $("#logo_cliente").after('<img src="'+e.target.result+'"width="80" height="80" style="position: relative; top: 10px; border-radius: 20px;">');
                    };
