                                ...
                                <div class="categoria">
                                    <div class="limita_icons">
                                        ...
                                        <div id="icon<%=cs.getId()%>" class="icon_categoria" style="
                                             background: url('servico/<%=servico.getNome()%>/<%=cs.getNome()%>/<%=cs.getImagem()%>');
                                             background-position: 50%;
                                             background-size: cover;
                                             background-repeat: no-repeat;
                                             ">
                                            ...
                                            <div id="painel<%=cs.getId()%>" class="painel_galeria_categoria">
                                                <%
                                                    for (GaleriaCategoria galeria : arrayGaleria) {
                                                        if (galeria.getCategoria().equals(cs.getNome())) {%>
                                                <script>
                                                ...
                                                <a href="servico/<%=servico.getNome()%>/<%=cs.getNome()%>/galeria/<%=galeria.getImagem()%>" data-lightbox="<%=galeria.getCategoria()%>">
                                                    <div class="imgGaleria" style="
                                                         background: url('servico/<%=servico.getNome()%>/<%=cs.getNome()%>/galeria/<%=galeria.getImagem()%>');
                                                         background-position: 50%;
                                                         background-size: cover;
                                                         background-repeat: no-repeat;
                                                         ">    
