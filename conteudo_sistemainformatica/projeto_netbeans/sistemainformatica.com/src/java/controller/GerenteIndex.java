 ...
 * @author Gilberto
 */
public class GerenteIndex extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GerenteIndex</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                if (isMultipart) {
                    ...
                    String caminho = getServletContext().getRealPath("/index");
                ...
                i.setLogo(nomeImagem);

                iDAO.alterarPaginaInicial(i);
