 ...
 * @author Gilberto
 */
public class GerenteImagemGaleriaCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GerenteImagemGaleriaCategoria</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                new File(caminho + File.separator + diretorio + File.separator + categoria + File.separator + "galeria" + File.separator + imagem).delete();
                
                response.sendRedirect("admin/form_alterar_servico.jsp?id=" + idServico + "&function=default");

            } catch (Exception e) {
                out.println("Não foi possível deletar da imagem: " + e.getMessage());
            }
