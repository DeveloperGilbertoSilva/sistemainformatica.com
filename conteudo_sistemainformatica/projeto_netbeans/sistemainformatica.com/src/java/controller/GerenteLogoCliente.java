 ...
 * @author Gilberto
 */
public class GerenteLogoCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GerenteLogoCliente</title>");            
            out.println("</head>");
            out.println("<body>");
                ...
                try {
                    ...
                    while (iter.hasNext()) {
                        ...
                        if (item.isFormField()){
                            ...
                            cList = cDAO.listaClienteEspecifico(id);
                    ...
                    response.sendRedirect("admin/form_alterar_cliente.jsp?id=" + id);
